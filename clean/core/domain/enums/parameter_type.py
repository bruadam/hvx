...
class ParameterType(str, Enum):
    ...
    VENTILATION = "ventilation"  # continuous measurable (ventilation rate)
    ...
    def display_name(self) -> str:
        ...
        names = {
            ...
            self.RADON: "Radon",
            self.VENTILATION: "Ventilation Rate",
    ...
    def measurement_types(self) -> List[MeasurementType]:
        ...
        types_map = {
            ...
            self.VENTILATION: [MeasurementType.CONTINUOUS, MeasurementType.INSPECTION],
    ...
    def tail_category(self) -> TAILCategory:
        ...
        categories = {
            ...
            self.VENTILATION: TAILCategory.INDOOR_AIR_QUALITY,
