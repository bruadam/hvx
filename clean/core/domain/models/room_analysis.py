...
class RoomAnalysis(BaseModel):
    ...
    # Data coverage
    data_time_range: Optional[TimeRange] = Field(default=None, description="Time range of data")
    ...
    def _recalculate_overall_compliance(self, standard: Optional[str] = None) -> None:
    ...
    def get_result_by_test(self, test_id: str) -> Optional[ComplianceResult]:
