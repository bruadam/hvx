...
class Violation(BaseModel):
    ...
    expected_min: Optional[float] = Field(default=None, description="Expected minimum value")
    expected_max: Optional[float] = Field(default=None, description="Expected maximum value")
