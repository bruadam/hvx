...
from core.entities import Room, Building, Floor
    ...
    def _get_metric_type(self, metric_name: str) -> MetricType:
        ...
        if 'temp' in metric_lower:
            if 'outdoor' in metric_lower or 'climate' in metric_lower:
                return MetricType.OUTDOOR_TEMPERATURE
            ...
            if 'outdoor' in metric_lower:
                return MetricType.OUTDOOR_HUMIDITY
        ...
        elif 'solar' in metric_lower or 'irradiance' in metric_lower or 'radiation' in metric_lower:
            return MetricType.SOLAR_IRRADIANCE
        elif 'energy' in metric_lower or 'kwh' in metric_lower:
            return MetricType.ENERGY
        elif 'heat' in metric_lower and 'district' in metric_lower:
            return MetricType.HEAT
