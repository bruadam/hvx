...
class CorrelationResult:
    ...
    interpretation: str
    mean_during_violations: float | None = None
    mean_during_compliance: float | None = None
...
class ClimateCorrelator:
    ...
    def correlate_with_climate(
        ...
        climate_parameters: list[str] | None = None,
...
def _interpret_climate_correlation(
    ...
    correlation: float,
    p_value: float,
    mean_violations: float | None = None,
    mean_compliance: float | None = None,
) -> str:
