...
class ComplianceThreshold(BaseModel):
    ...
    lower_limit: float | None = Field(default=None, description="Lower acceptable limit")
    upper_limit: float | None = Field(default=None, description="Upper acceptable limit")
    ...
    @classmethod
    def validate_limits(cls, v: float | None, info: dict) -> float | None:
