...
class TAILCircularChart:
    ...
    def create(
        ...
        thermal_rating: int | None = None,
        acoustic_rating: int | None = None,
        iaq_rating: int | None = None,
        luminous_rating: int | None = None,
        thermal_details: dict[str, int | None] | None = None,
        acoustic_details: dict[str, int | None] | None = None,
        iaq_details: dict[str, int | None] | None = None,
        luminous_details: dict[str, int | None] | None = None,
    ...
    def _draw_center_circle(self, ax: Axes, rating: int | None):
    ...
    def _draw_hierarchical_details(
        self,
        ax: Axes,
        thermal_details: dict[str, int | None] | None,
        acoustic_details: dict[str, int | None] | None,
        iaq_details: dict[str, int | None] | None,
        luminous_details: dict[str, int | None] | None
    ) -> list:
        """
        ...
        for details, start_angle, end_angle, _component in quadrants:
    ...
    def calculate_from_building_analysis(
        ...
        if room_analyses:
            ...
            for ra in room_analyses:
                for _test_id, result in ra.compliance_results.items():
