...
"""
    ...
    def _render_summary_section(
        self, section: SectionConfig, room_analyses: list[RoomAnalysis] | None
    ) -> str:
...
"""
    ...
    def _render_kpi_cards(
        self,
        section: SectionConfig,
        room_analyses: list[RoomAnalysis] | None,
        building_analysis: BuildingAnalysis | None,
    ) -> str:
...
"""
    ...
    def _render_executive_summary(
        self, section: SectionConfig, building_analyses: list[BuildingAnalysis] | None
    ) -> str:
...
"""
    ...
    def _render_category_distribution_table(
        ...
        for _test_id, result in room_analysis.compliance_results.items():
